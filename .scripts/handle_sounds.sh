...
if [ $STATE -eq 1 ]; then
	echo "### This file auto-generated by https://github.com/ZwerOxotnik/factorio-multi-template-mod" >> $CFG_FULLPATH
...
echo "-- This file auto-generated by https://github.com/ZwerOxotnik/factorio-multi-template-mod" >> $SOUNDS_LIST_PATH
